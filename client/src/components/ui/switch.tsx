...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-primary data-[state=checked]:border-primary/20 data-[state=checked]:shadow-lg",
      "data-[state=unchecked]:bg-muted data-[state=unchecked]:border-border data-[state=unchecked]:shadow-sm",
